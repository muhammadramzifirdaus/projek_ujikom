                    ...
                    @forelse($peminjamans as $peminjaman)
                        <tr class="hover:bg-gray-50 transition align-top">
                            ...
                            <td class="py-3 px-4 border-b text-xs text-gray-600">
                                <span class="block"><strong class="text-gray-700">Pinjam:</strong> {{ $peminjaman->tgl_pinjam }}</span>
                                <span class="block font-semibold text-gray-800"><strong class="text-gray-700">Rencana:</strong> {{ $peminjaman->tgl_kembali_plan }}</span>
                            </td>
                            <td class="py-3 px-4 border-b">
