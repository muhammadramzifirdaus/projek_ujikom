    ...
    <form action="{{ route("admin.peminjaman.store") }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <div id="alat-container" class="space-y-3">
                <div class="flex items-center gap-3 alat-row">
                    ...
                    <button type="button" onclick="removeRow(this)" class="bg-red-500 text-white px-3 py-2 rounded-lg text-xs hover:bg-red-600 transition">Hapus</button>
                </div>
            </div>
            <button type="button" onclick="addRow()" class="mt-3 bg-gray-800 hover:bg-gray-900 text-white text-xs font-semibold px-4 py-2 rounded-lg transition">
                + Tambah Alat Lain
            </button>
        </div>
